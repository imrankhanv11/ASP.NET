...
namespace BookManagement.Tests
{
    public class CategoryServiceTest
    {
        ...
        public async Task GetAllCatService_ShouldReturnCatList_WhenCatExits()
        {
            ...
            _mapper.Setup(s => s.Map<IEnumerable<GetAllCategoryDTO>>(fakeCatList))
                .Returns(fakeCatList.Select(s => new GetAllCategoryDTO
                {
        ...
        public async Task GetOneCatService_ShouldReturnCat_WhenCatExits()
        {
            ...
            using (new AssertionScope())
            {
                // Assert
                result.Should().NotBeNull();
                result.CategoryName.Should().Be(fake.CategoryName);
        ...
        public async Task AddNewCatService_ShouldReturnId_WhenCatAdded()
        {
            ...
            using(new AssertionScope())
            {
                ...
                // Verify
                _mapper.Verify(m => m.Map<Category>(It.IsAny<AddCatDto>()), Times.Once());
                _catRepo.Verify(m=> m.AddAsync(It.IsAny<Category>()), Times.Once());
            }
        }
        ...
        public async Task DeleteCatService_ShouldReturnTrue_WhenCatDeleted()
        {
            ...
            using(new AssertionScope())
            {
                ...
                // Verify
                _catRepo.Verify(c=> c.GetByIdAsync(It.IsAny<int>()), Times.Once());
                _catRepo.Verify(c => c.DeleteAsync(It.IsAny<int>()), Times.Once());
            }
        }
        ...
        public async Task DeleteCatService_ShouldReturnFalse_WhenCatNotExits()
        {
            ...
            using(new AssertionScope())
            {
                ...
                // Verify
                _catRepo.Verify(c => c.DeleteAsync(It.IsAny<int>()), Times.Never());
