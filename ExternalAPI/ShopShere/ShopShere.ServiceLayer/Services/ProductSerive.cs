...
namespace ShopSphere.ServiceLayer.Services
{
    public class ProductSerive : IProductService
    {
        ...
        public async Task<GetAllProductsDTO> AddNewProductService(AddProductDTO dto)
        {
        ...
        public async Task<UpdateProductRespontDTO> UpdateProductService(UpdateProductDTO dto, int id)
        {
            var checkProduct = await _repo.CheckProductExitsRepo(dto.Name);
            ...
            var returnProuct = await _repo.UpdateProduct(result);

            return new UpdateProductRespontDTO
            {
                ProductId = returnProuct.ProductId,
                Name = returnProuct.Name,
                Description = returnProuct.Description,
                Stock = returnProuct.Stock,
                Price = returnProuct.Price
            };
        }
    }
}
